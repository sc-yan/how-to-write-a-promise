...
new Promise2((resolve, reject) => {
  ...
  val => console.log('promise 测试: val', val),
  err => console.error('promise 测试: err' + err)
)
...
Promise2.all(getPList()).then(
  data => console.log('promise.all 测试: sucess', data),
  err => console.error('promise.all 测试: fail' + err)
)

Promise2.race(getPList()).then(
  data => console.log('promise.race 测试: s', data),
  err => console.error('promise.race 测试: fail' + err)
)